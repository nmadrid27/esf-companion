...
3. Compare the two versions.
   - If the remote version is higher, tell the user: "ESF toolkit update available (local: v[local], latest: v[remote])." Then ask: "Want me to run the installer to update? This will refresh skills, templates, and reference files. Your workspace state file and project folders are preserved."
