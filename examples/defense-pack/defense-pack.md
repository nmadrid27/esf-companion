# Defense recording: responsive-system

> Read aloud. Each section's `[~X min]` cue is a pace target, not a hard limit.
> Aim for 12-15 minutes total. Skip sections marked "(omitted: ...)".

---

*(Opening omitted: jump straight into 'How I came in'.)*

## How I came in `[~2 min]`

I came in wanting friction over flow. My position was clear from day one: the system should respond to the user, not perform for them. Every transition earned by a user action, no autoplay, no idle animation.
...
> *Reference: Record #1 (2026-04-20). Full detail in the appendix.*
...
> *Reference: Record #3 (2026-04-25). Full detail in the appendix.*
...
*Recording prepared from Defense Pack. Project: responsive-system. Student: Alex. Generated: FIXED.*
