...
if [ "$PLATFORM" = "cowork" ]; then
  ...
  if curl -fsSL "$PLUGIN_URL" -o "$PLUGIN_DEST"; then
    ...
    echo -e "${YELLOW}This is the Cowork plugin from the latest companion-v release.${NC}"
    ...
    echo ""
    echo "The latest companion-v release should include esf-companion.plugin."
    echo "If this failed, you may be offline, or GitHub may be unreachable."
    echo ""
