...
Your Position Statement is the most important thing you write before starting a project. It goes in `esf/[context]/position-statements/` before any AI tool opens.
...
Document it in `esf/[context]/records-of-resistance/`:
...
Save it to `esf/[context]/position-statements/` like any other Position Statement. Note in the file that it is retrospective.
