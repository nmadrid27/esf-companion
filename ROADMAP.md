...
|----------|-------------|-------------|------|--------|
| **Record of Resistance** | User writes, Companion prompts and pre-fills "what AI suggested" | Writes the reasoning (why rejected, what instead) | Real-time, when rejection happens | [SHIPPED] |
...
- Pre-filled Records of Resistance (Companion fills "what AI suggested") [SHIPPED]
